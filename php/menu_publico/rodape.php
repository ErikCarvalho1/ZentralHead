    ...
    <div class="row text-start">
      ...
      <div class="col-md-4 mb-4">
        ...
        <ul class="list-unstyled">
          ...
          <li><a href="#" class="text-white-50 text-decoration-none d-block">Política de Privacidade</a></li>
        </ul>
      </div>
      ...
      <div class="col-md-8 mb-4">
        ...
        <form class="d-flex flex-wrap" style="max-width: 500px;">
          <input type="email" class="form-control me-2 mb-2 bg-dark text-white border-secondary" placeholder="e-mail" required>
          <button class="btn btn-outline-light mb-2 px-4" type="submit">Enviar</button>
        </form>
      </div>
    </div>
