...
CREATE TABLE `usuarios` (
  ...
  CONSTRAINT `fk_usuarios_niveis` FOREIGN KEY (`nivel_id`) REFERENCES `niveis` (`id`),
...
INSERT INTO `usuarios` VALUES (1008,'dde','e@r','d9b1d7db4cd6e70935368a1efb10e377',9,_binary ''),(1009,'dde','e@e','d9b1d7db4cd6e70935368a1efb10e377',10,_binary ''),(1010,'dadd','a@a','d9b1d7db4cd6e70935368a1efb10e377',10,_binary ''),(1011,'dadd','b@b','202cb962ac59075b964b07152d234b70',10,_binary '');
