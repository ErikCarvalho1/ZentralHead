...
CREATE TABLE `produto_desconto` (
  ...
  CONSTRAINT `produto_desconto_ibfk_1` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`) ON DELETE CASCADE,
  CONSTRAINT `produto_desconto_ibfk_2` FOREIGN KEY (`desconto_id`) REFERENCES `descontos` (`id`) ON DELETE CASCADE
...
INSERT INTO `produto_desconto` VALUES (1,1),(2,2),(7,1),(8,2);
