...
-- Schema testeM
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `testeM` DEFAULT CHARACTER SET utf8mb4 ;
-- -----------------------------------------------------
-- Schema zentralhead
-- -----------------------------------------------------
...
-- Table `testeM`.`niveis`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`niveis` (
...
-- -----------------------------------------------------
-- Table `testeM`.`usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`usuarios` (
...
-- -----------------------------------------------------
-- Table `testeM`.`produtos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`produtos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `testeM`.`avaliacoes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`avaliacoes` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `avaliacoes_ibfk_1`
    ...
    REFERENCES `testeM`.`usuarios` (`id`)
    ON DELETE CASCADE,
  CONSTRAINT `avaliacoes_ibfk_2`
    FOREIGN KEY (`produtos_id`)
    REFERENCES `testeM`.`produtos` (`id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- Table `testeM`.`caixas`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`caixas` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `testeM`.`categorias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`categorias` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `testeM`.`clientes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`clientes` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(100) NOT NULL,
...
-- Table `testeM`.`cores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`cores` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `testeM`.`descontos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`descontos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(100) NOT NULL,
...
-- -----------------------------------------------------
-- Table `testeM`.`enderecos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`enderecos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `testeM`.`fornecedores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`fornecedores` (
  `id` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `testeM`.`pedidos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`pedidos` (
  `id` INT(4) NOT NULL AUTO_INCREMENT,
  `usuario_id` INT(4) NOT NULL,
  `cliente_id` INT(4) NOT NULL,
...
-- -----------------------------------------------------
-- Table `testeM`.`produto_desconto`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`produto_desconto` (
  ...
  CONSTRAINT `produto_desconto_ibfk_2`
    ...
    REFERENCES `testeM`.`descontos` (`id`)
    ON DELETE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
...
-- -----------------------------------------------------
-- Table `testeM`.`tamanhos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`tamanhos` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(50) NOT NULL,
  `criado_em` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP(),
  PRIMARY KEY (`id`))
...
-- -----------------------------------------------------
-- Table `testeM`.`produto_detalhes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`produto_detalhes` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `produto_id` INT(11) NOT NULL,
...
-- Table `testeM`.`teste`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `testeM`.`teste` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4;
